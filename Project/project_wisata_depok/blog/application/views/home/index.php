...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('dists/css/style.css')?> ">
...
<body class="is-boxed has-animations">
            ...
            <div class="container">
                <div class="site-header-inner">
                                ...
                                <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <radialGradient cy="0%" fx="50%" fy="0%" r="100%" id="logo-gradient">
                                            ...
                                            <stop stop-color="#F0FFFF" stop-opacity=".24" offset="100%"/>
                                        </radialGradient>
                                    </defs>
                    ...
                    <ul class="header-links list-reset m-0">
                        ...
                        <li>
                            <a href="<?php echo base_url('index.php/tempat_wisata/index')?>">Tempat Wisata</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('index.php/login/index')?>">Login</a>
                        </li>
                        <li>
                            <a class="button button-sm button-shadow" href="<?php echo base_url('index.php/register/index')?>">Signup</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <section class="hero text-light text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Wisata Depok</h1>
                        <p class="hero-paragraph is-revealing">Website ini menyediakan informasi mengenai tempat-tempat wisata di Depok</p>
                        <p class="hero-cta is-revealing"><a class="button button-secondary button-shadow" href="#">Mulai</a></p>
                        <div class="hero-media">
                            <img src="<?php echo base_url('dists/img/depok.jpg')?>" alt="" srcset="">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="features section text-center">
                <div class="container">
                    <div class="features-inner section-inner has-top-divider">
                        <h2 class="section-title mt-0">Fitur Produk</h2>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Jenis Wisata</h4>
                                    <p class="text-sm">Fitur untuk memberi tahu jenis wisata yang anda cari</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Tempat Wisata</h4>
                                    <p class="text-sm">Fitur untuk mengetahui informasi mengenai tempat wisata</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Nilai Rating</h4>
                                    <p class="text-sm">Fitur untuk melihat rating sebuah tempat wisata yang diinput oleh user</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Komentar</h4>
                                    <p class="text-sm">Fitur untuk melihat komentar user lain dan menambahkan komentar sendiri</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="features-extended-inner section-inner has-top-divider">
                        <div class="features-extended-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Tempat-tempat Wisata di Depok</h2>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                <img src="<?php echo base_url('dists/img/wisata_pasir_putih1.png')?>" alt="">
                                    <defs>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Taman Wisata Pasir Putih</h3>
                                <p>Taman rekreasi air keluarga dengan kolam renang outdoor, seluncuran air, taman bermain, dan kedai makanan.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                <img src="<?php echo base_url('dists/img/situasih.jpg')?>" alt="">
                                    <defs>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Situ Asih Pulo</h3>
                                <p>Danau kota populer untuk memancing & berkemah, dikelilingi jalan di tengah pohon palem & tumbuhan lebat lain.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/pondok_zidane3.jpg')?>" alt="">
                                    <defs>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Pondok Zidane</h3>
                                <p>Pusat aktivitas luar ruangan yang alami dengan kolam renang, rintangan ketinggian, game, berkemah, penginapan.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/herbal_insani1.jpg')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Taman Herbal Insani</h3>
                                <p>Tempat rekreasi alam terbuka sekaligus edukasi tanaman obat.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/godongijo1.png')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Godong Ijo</h3>
                                <p>Kelas untuk segala usia yang mengajarkan ekologi & ekosistem di objek wisata dengan resto bernuansa hutan ini.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/dkandang3.jpg')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">D'Kandang Amazing Farm</h3>
                                <p>Tempat wisata Depok yang mengusung edu-wisata yang menawarkan konsep pertanian dan peternakan.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/lembah_mawar4.jpg')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Lembah Mawar</h3>
                                <p>Sebuah taman di Kota Depok, Provinsi Jawa Barat.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/wiladatika1.png')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Taman Wiladatika</h3>
                                <p>Jalur rindang, kolam renang, kereta mainan & area bermain anak-anak di dalam area hijau yang luas.</p>
                            </div>
                        </div>
                        <div class="feature-extended">
                            <div class="feature-extended-image is-revealing">
                                    <img src="<?php echo base_url('dists/img/studio_alam_tvri3.png')?>" alt="">
                                    <defs>
                                        <filter x="-500%" y="-500%" width="1000%" height="1000%" filterUnits="objectBoundingBox" id="dropshadow-3">
                                            <feOffset dy="16" in="SourceAlpha" result="shadowOffsetOuter"/>
                                            <feGaussianBlur stdDeviation="24" in="shadowOffsetOuter" result="shadowBlurOuter"/>
                            ...
                            <div class="feature-extended-body">
                                <h3 class="mt-0">Studio Alam TVRI</h3>
                                <p>Area taman berhutan yang menawarkan jalur rindang & latar untuk foto, plus lokasi syuting dan pernikahan.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo base_url('dists/js/main.min.js')?>"></script>
</body>
</html>
